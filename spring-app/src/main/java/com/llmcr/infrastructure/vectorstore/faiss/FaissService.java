...
public class FaissService {
  ...
  public record AddVectorsRequest(String index_name, List<Long> ids, List<float[]> vectors) {
    ...
    public boolean equals(Object o) {
      ...
      if (!(o instanceof AddVectorsRequest other)) return false;
    ...
    public int hashCode() {
      ...
      if (vectors != null) {
        for (float[] v : vectors) result = 31 * result + Arrays.hashCode(v);
      }
      return result;
    }
    ...
    public String toString() {
      List<String> vStrs = vectors == null ? null : vectors.stream().map(Arrays::toString).toList();
      return "AddVectorsRequest[index_name="
          + index_name
          + ", ids="
          + ids
          + ", vectors="
  ...
  public record SearchVectorsRequest(String index_name, float[] qvector, int top_k) {
    ...
    @Override
    public String toString() {
      return "SearchVectorsRequest[index_name="
          + index_name
          + ", qvector="
