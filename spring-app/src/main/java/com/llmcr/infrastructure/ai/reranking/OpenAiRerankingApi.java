...
public class OpenAiRerankingApi {
  ...
  public OpenAiRerankingApi(WebClient.Builder builder, String baseUrl, String apiKey) {
    ...
    this.webClient =
        builder.baseUrl(baseUrl).defaultHeader("Authorization", "Bearer " + apiKey).build();
  }
  ...
  public record RerankingApiResponse(
      String model, String object, Usage usage, List<Result> results) {
