...
public class TextCleaner {
  ...
  private static final String SERIALIZED_ATN_REPLACEMENT =
      "_serializedATN = \"<ANTLR_SERIALIZED_ATN>\";";

  /**
   * Cleans the text by removing control characters (except CR, LF, and TAB), replacing serialized
   * ATN literals, collapsing multiple spaces/tabs into one.
   */
