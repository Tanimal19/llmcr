...
public class Chunk {
  ...
  /**
   * Which collections the chunk belongs to. A chunk can belong to multiple collections, and a
   * collection can have multiple chunks. The chunk should only be add to a collection after
   * loading, so that we can track which chunks have been loaded.
   */
