    ...
    try {
      ...
      try {
        ...
        throw new APIServiceException(
            APIServiceException.ErrorCode.ETL_LOAD_FAILED, "ETL load-after-split stage failed", ex);
      }
      ...
      throw new APIServiceException(
          APIServiceException.ErrorCode.ETL_RUN_FAILED, "ETL pipeline execution failed", ex);
    }
  }
}
