...
/**
 * This class is responsible for initializing the database with the track roots and collections
 * defined in the configuration. This will be run every time the application starts.
 */
@Component
