...
public class TrackRootConfigSynchronizer {
  ...
  public TrackRootConfigSynchronizer(
      TrackRootRepository trackRootRepository, TrackRootConfigProvider trackRootConfigProvider) {
  ...
  private boolean upsertConfiguredTrackRoots() {
    boolean changed = false;
    for (TrackRootConfig configuredTrackRoot :
        trackRootConfigProvider.getAllConfiguredTrackRoots().values()) {
