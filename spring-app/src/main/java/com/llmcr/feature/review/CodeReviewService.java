...
public class CodeReviewService
    ...
    public CodeReviewOutput execute(
        ...
        try {
            ...
            Path cachedDirectory = CodeReviewSupport.rebuildChangedJavaFilesToCache(prData, outputDir,
                    prefixDirectory);
            ...
            String codeAnalysis = "PMD Output:\n" + pmdOutput + "\nCheckstyle Output:\n" + checkstyleOutput;
            emitProgress(
                    progressListener,
                    STAGE_STATIC_ANALYSIS,
    ...
    private CodeReviewOutput finalizeReview(
        ...
        CodeReviewReport review = new CodeReviewReport(prData.prId(), prData.title(), reviewResult, interpretation,
                items);
